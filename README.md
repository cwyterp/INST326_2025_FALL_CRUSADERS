...
storyA.md: a story file for a single round

storyB.md: a story file for a single round

storyC.md: a story file for a single round

storyline.json: 

storyline.md: provide an overall storyline
